					...
					<div class="product-details"><!--product-details-->
						<div class="col-sm-5">
							<div class="view-product">
								<img src="<c:url value = 'E:\Sutta\Work\shoppingcart\img\id${selectedProduct.id}.jpg"' />" alt="" />
								<h3>ZOOM</h3>
							</div>
						...
						<div class="col-sm-7">
							<div class="product-information"><!--/product-information-->
								...
								<span>
									...
									<a href="<c:url value='/cart/add/${selectedProduct.id}' />" class="btn btn-default add-to-cart"><i
